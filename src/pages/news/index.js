    ...
    <Accordion>
      <Card>
        ...
        <Accordion.Collapse eventKey="0">
          <Card.Body>Startup Hub is a group of entrepreneurs registered under the roof of Insfra Technologies. By registering, you will be able to turn your business idea into a reality, get mentored, transfer knowledge, share experience and grow with Insfra Technologies.</Card.Body>
        </Accordion.Collapse>
      </Card>
      ...
      <Card>
        ...
        <Accordion.Collapse eventKey="1">
          <Card.Body>Simple. Click “Register for Entrepreneurship” and follow the steps. This link is also available in the Entrepreneurship page of the site. </Card.Body>
        </Accordion.Collapse>
      </Card>
      ...
      <Card>
        ...
        <Accordion.Collapse eventKey="2">
          <Card.Body>No. You will not have to pay for the entitled benefits.</Card.Body>
        </Accordion.Collapse>
      </Card>
