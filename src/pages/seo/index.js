...
const SeoPage = () => (
  <LayoutPage>
    ...
    <CardDeck>
      ...
      <Card>
        <Card.Title>ASO Getting ranked in App Store</Card.Title>
        <Card.Header style={{ backgroundColor: "#dee2e6" }}>
      ...
      <Card>
        <Card.Title>SEO/ASO Consultancy - How to Optimize</Card.Title>
        <Card.Header style={{ backgroundColor: "#dee2e6" }}>
          App Store Optimization
        </Card.Header>
      ...
      <Card>
        <Card.Title>WIX /Wordpress SEO</Card.Title>
    ...
    <CardDeck>
      <Jumbotron>
        ...
        <br />
        <p> We believe in conversions more than the impressions. Therefore, we
          ...
          the right audience though sales funnel strategies.</p>
        <Card.Text>
