...
const EntraprenureshipPage = () => (
  <LayoutPage>
    ...
    <CardGroup>
      <Card>
        ...
        <Card.Body>
          ...
          <Card.Text>
            Get expert Search Engine Optimization and App Store Optimization
            services for your business. We cater from sole proprietorship to
            corporate to get the website/pages ranked in searches and convert
            for sales
            <br />
          </Card.Text>
          <h3>Small & Medium Business Solutions</h3>
          <Card.Title>SEO Getting ranked in Search Results?</Card.Title>
          <CardDeck>
            
            <Card>
            <Card.Header>Market research</Card.Header>
              {/* <Card.Img
                variant="top"
      ...
      <Card>
        ...
        <Card.Body>
          ...
          <Card.Title>ASO SERVICES</Card.Title>
          <CardDeck>
            <Card>
              <Card.Img
                variant="top"
    ...
    <CardDeck>
      <Card>
        <Card.Header>Customer 1</Card.Header>
      </Card>
      <Card>
        <Card.Header>Customer 2</Card.Header>
      </Card>
      <Card>
        <Card.Header>Customer 3</Card.Header>
      </Card>
      <Card>
        <Card.Header>Customer 4</Card.Header>
      </Card>
    </CardDeck>
    <br />
    ...
    <CardDeck>
      <Jumbotron>
        <h1 align="center">why you should choose us...</h1>
        <br />
        <Card.Text>
          <h3>Why someone should choose Insfra for SEO/ASO</h3>
        </Card.Text>
        ...
        <CardDeck>
          ...
          <Card>
            ...
            />
            <Card.Body>
              <Card.Title>Experiance</Card.Title>
              <Card.Text>
                This card has supporting text below as a natural lead-in to
                additional content.{" "}
              </Card.Text>
          ...
          <Card>
            ...
            />
            <Card.Body>
              <Card.Title>Negotiation</Card.Title>
              <Card.Text>
                This card has supporting text below as a natural lead-in to
                additional content.{" "}
              </Card.Text>
          ...
          <Card>
            ...
            />
            <Card.Body>
              <Card.Title>Updated Knowledge</Card.Title>
              <Card.Text>
                This card has supporting text below as a natural lead-in to
                additional content.{" "}
              </Card.Text>
          ...
          <Card>
            ...
            />
            <Card.Body>
              <Card.Title>Efficient</Card.Title>
              <Card.Text>
                This card has supporting text below as a natural lead-in to
                additional content.{" "}
              </Card.Text>
    ...
    <Accordion>
      ...
      <Card>
        ...
        <Accordion.Collapse eventKey="1">
          <Card.Body>Hello! I'm Answer</Card.Body>
        </Accordion.Collapse>
      </Card>
      <Card>
        <Card.Header>
